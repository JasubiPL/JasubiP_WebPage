...
import { getFilesBySlugNCV1, getFilesNCV1 } from '@/lib/nobody-cares-vol-1-mdx';
...
export async function getStaticProps({ params }){
  const { source, frontmatter } = await getFilesBySlugNCV1(params.slug);
...
export async function getStaticPaths() {
  const posts = await getFilesNCV1();
